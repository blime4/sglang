---
name: sglang-modify
description: Convention for Denglin (登临/DLIN) modifications to sglang — how to mark and place DL changes so the DL diff stays greppable and survives upstream syncs. Read before editing sglang source for DLIN. Enforced by scripts/dl/check_dl_markers.py at commit time.
---

# sglang-modify — DLIN modification convention

**Goal:** every Denglin (登临/DLIN) change to sglang must be trivially findable
