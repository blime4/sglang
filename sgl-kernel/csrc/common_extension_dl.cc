...
TORCH_LIBRARY_EXPAND(sgl_kernel, m) {
  ...
  // DL: include bool ignore_invalid_expert to match the shared 9-arg function
  // signature (moe_align_kernel.cu). The .def was stale (8-arg), which made
  // .impl mismatch -> c10::Error -> 'import sgl_kernel' aborted at load time.
  m.def(
